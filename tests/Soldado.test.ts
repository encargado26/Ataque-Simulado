...
describe("Soldado sin escudo", () => {
  it("muere con un solo disparo de otro soldado", () => {
    const soldado1 = new Soldado(new _EscudoConPorcentaje(100)); // atacante
    const soldado2 = new Soldado(new _EscudoConPorcentaje(0)); // defensor
  ...
  it("resiste 4 disparos y muere en el quinto", () => {
    const atacante = new Soldado(new _EscudoConPorcentaje(100));
